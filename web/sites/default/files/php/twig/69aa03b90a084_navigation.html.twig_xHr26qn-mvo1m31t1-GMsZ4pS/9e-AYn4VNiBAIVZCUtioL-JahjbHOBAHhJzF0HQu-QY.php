...
<div ";
  ...
  <div class=\"admin-toolbar-control-bar__content\">
    ";
        // line 24
        yield from $this->loadTemplate("navigation:toolbar-button", "@navigation/layouts/navigation.html.twig", 24)->unwrap()->yield(CoreExtension::toArray(["attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-expanded" => "false", "aria-controls" => "admin-toolbar", "type" => "button"]), "icon" => "burger", "text" => t("Expand sidebar"), "modifiers" => ["small-offset"], "extra_classes" => ["admin-toolbar-control-bar__burger"]]));
        // line 33
        yield "  </div>
</div>
  ...
  <div class=\"admin-toolbar__scroll-wrapper\">
    ";
      ...
      ";
        ...
        ";
        // line 49
        if ( !CoreExtension::getAttribute($this->env, $this->source, ($context["settings"] ?? null), "hide_logo", [], "any", false, false, true, 49)) {
            // line 50
            ...
            ";
            // line 51
            if ( !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["settings"] ?? null), "logo_path", [], "any", false, false, true, 51))) {
                // line 52
                yield "              <img alt=\"";
            ...
            ";
                ...
                // line 54
                yield "              ";
                yield from $this->loadTemplate("@navigation/logo.svg.twig", "@navigation/layouts/navigation.html.twig", 54)->unwrap()->yield(CoreExtension::toArray(["label" => t("Navigation logo")]));
                // line 57
                yield "            ";
            }
            // line 58
        ...
        // line 60
        yield "        ";
        yield from $this->loadTemplate("navigation:toolbar-button", "@navigation/layouts/navigation.html.twig", 60)->unwrap()->yield(CoreExtension::toArray(["attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["data-toolbar-back-control" => true, "tabindex" => "-1"]), "extra_classes" => ["admin-toolbar__back-button"], "icon" => "back", "text" => t("Back")]));
        // line 66
        yield "        ";
        yield from $this->loadTemplate("navigation:toolbar-button", "@navigation/layouts/navigation.html.twig", 66)->unwrap()->yield(CoreExtension::toArray(["action" => t("Collapse sidebar"), "attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-controls" => "admin-toolbar", "tabindex" => "-1", "type" => "button"]), "extra_classes" => ["admin-toolbar__close-button"], "icon" => "cross"]));
        // line 72
        yield "      </div>
...
";
    ...
    {
        return array (  159 => 83,  154 => 81,  148 => 80,  143 => 79,  141 => 78,  135 => 75,  131 => 74,  127 => 72,  124 => 66,  121 => 60,  117 => 58,  114 => 57,  111 => 54,  99 => 52,  97 => 51,  92 => 50,  90 => 49,  87 => 48,  81 => 46,  76 => 45,  74 => 44,  72 => 43,  67 => 40,  62 => 37,  56 => 33,  54 => 24,  49 => 22,  46 => 21,  44 => 20,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@navigation/layouts/navigation.html.twig", "/var/www/html/magnus/web/core/modules/navigation/layouts/navigation.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = ["create_attribute" => 20, "path" => 50];
