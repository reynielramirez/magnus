...
$settings['update_disabled_extensions'] = TRUE;
 ...
 * @endcode
 */
$settings['hash_salt'] = '_kbY8dJA2MwgiWUgiPxF_34wTl9kpVjAotTbfmLVsrTROzYR_Jlx0nOZPX62VPy3uv3Ax2lInQ';
...
$config['package_manager.settings']['executables']['composer'] = '/usr/local/bin/composer-wrapper';
 ...
 */
 $settings['file_private_path'] = '/opt/magnus/backup';
 ...
 */
 $settings['file_temp_path'] = '/opt/magnus/tmp';
...
$settings['config_sync_directory'] = 'sites/default/files/config_hdEXclSBJdhPoGrEKBRIB1D9mzlyP2pZLf2l8LEAAawMg-5vDMzZH6s5m6h2_OQMez7TeQRZ8w/sync';
